...
impl StaticUpcast<QAnyStringView> for QString {
    unsafe fn static_upcast(ptr: Ptr<Self>) -> Ptr<QAnyStringView> {
        ...
        Ptr::from_raw(crate::__ffi::ctr_qt_core_ffi_QAnyStringView_QAnyStringView2(
            ptr.as_raw_ptr(),
        ))
    }
}
...
impl StaticUpcast<QAnyStringView> for QByteArray {
    unsafe fn static_upcast(ptr: Ptr<Self>) -> Ptr<QAnyStringView> {
        ...
        Ptr::from_raw(crate::__ffi::ctr_qt_core_ffi_QAnyStringView_QAnyStringView1(
            ptr.as_raw_ptr(),
        ))
    }
}
...
impl StaticUpcast<QAnyStringView> for QLatin1String {
    unsafe fn static_upcast(ptr: Ptr<Self>) -> Ptr<QAnyStringView> {
        ...
        Ptr::from_raw(crate::__ffi::ctr_qt_core_ffi_QAnyStringView_QAnyStringView3(
            ptr.as_raw_ptr(),
        ))
    }
}
...
impl StaticUpcast<QAnyStringView> for QStringView {
    unsafe fn static_upcast(ptr: Ptr<Self>) -> Ptr<QAnyStringView> {
        ...
        Ptr::from_raw(crate::__ffi::ctr_qt_core_ffi_QAnyStringView_QAnyStringView4(
            ptr.as_raw_ptr(),
        ))
    }
}
