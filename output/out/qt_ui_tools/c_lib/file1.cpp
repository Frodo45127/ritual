...
RITUAL_EXPORT QList< QString > * ctr_qt_ui_tools_ffi_QUiLoader_pluginPaths(QUiLoader const * this_ptr) {
  return new QList< QString >(this_ptr->pluginPaths());
}
...
RITUAL_EXPORT QList< QString > * ctr_qt_ui_tools_ffi_QUiLoader_availableWidgets(QUiLoader const * this_ptr) {
  return new QList< QString >(this_ptr->availableWidgets());
}


RITUAL_EXPORT QList< QString > * ctr_qt_ui_tools_ffi_QUiLoader_availableLayouts(QUiLoader const * this_ptr) {
  return new QList< QString >(this_ptr->availableLayouts());
}
